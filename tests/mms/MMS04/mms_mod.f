...
! local variables: coefficients in manufactured solutions
      ...
      case(2)
      !ug!
        mms_function = xt**2*(awgy*Pi*wgy*Cos(awgy*Pi*yt) + &
      ...
      case(3)
      !vg!
        mms_function = xt**2*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + &
          ...
          2*xt*(-wg0 - wgx*Cos(awgx*Pi*xt) - wgz*Cos(awgz*Pi*zt) - &
          wgzx*Cos(awgzx*Pi*xt*zt) - wgy*Sin(awgy*Pi*yt) - &
          wgxy*Sin(awgxy*Pi*xt*yt) - wgyz*Sin(awgyz*Pi*yt*zt))
      case(4)
      !wg!
        mms_function = xt**2*(avgx*Pi*vgx*Cos(avgx*Pi*xt) - &
          ...
          2*xt*(vg0 + vgy*Cos(avgy*Pi*yt) + vgxy*Cos(avgxy*Pi*xt*yt) + &
          vgz*Cos(avgz*Pi*zt) + &
          vgzx*Cos(avgzx*Pi*xt*zt) + vgx*Sin(avgx*Pi*xt) + &
...
! local variables within source functions
      ...
      !ugsrc!
       ...
       2*xt**4*(awgxy*Pi*wgxy*Cos(awgxy*Pi*xt*yt) + avgzx**2*Pi**2*vgzx*xt*zt*Cos(avgzx*Pi*xt*zt) - awgxy**2*Pi**2*wgxy*xt*yt*Sin(awgxy*Pi*xt*yt) + &
          avgzx*Pi*vgzx*Sin(avgzx*Pi*xt*zt))*(awgy*Pi*wgy*Cos(awgy*Pi*yt) + awgxy*Pi*wgxy*xt*Cos(awgxy*Pi*xt*yt) - avgyz*Pi*vgyz*yt*Cos(avgyz*Pi*yt*zt) + &
       ...
       mug*(4*xt*(awgxy*Pi*wgxy*Cos(awgxy*Pi*xt*yt) + avgzx**2*Pi**2*vgzx*xt*zt*Cos(avgzx*Pi*xt*zt) - awgxy**2*Pi**2*wgxy*xt*yt*Sin(awgxy*Pi*xt*yt) + &
          ...
          xt**2*(-(awgxy**3*Pi**3*wgxy*xt*yt**2*Cos(awgxy*Pi*xt*yt)) + 2*avgzx**2*Pi**2*vgzx*zt*Cos(avgzx*Pi*xt*zt) - 2*awgxy**2*Pi**2*wgxy*yt*Sin(awgxy*Pi*xt*yt) - &
             avgzx**3*Pi**3*vgzx*xt*zt**2*Sin(avgzx*Pi*xt*zt))) - mug*(2*&
           (-(awgy*Pi*wgy*Cos(awgy*Pi*yt)) - awgxy*Pi*wgxy*xt*Cos(awgxy*Pi*xt*yt) - awgyz*Pi*wgyz*zt*Cos(awgyz*Pi*yt*zt)) + &
          xt**2*(awgxy**3*Pi**3*wgxy*xt*yt**2*Cos(awgxy*Pi*xt*yt) + 2*awgxy**2*Pi**2*wgxy*yt*Sin(awgxy*Pi*xt*yt)) + &
          2*xt*(-(awgxy*Pi*wgxy*Cos(awgxy*Pi*xt*yt)) + awgxy**2*Pi**2*wgxy*xt*yt*Sin(awgxy*Pi*xt*yt)) + &
          2*xt*(-(awgxy*Pi*wgxy*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*Cos(augyz*Pi*yt*zt) + awgxy**2*Pi**2*wgxy*xt*yt*Sin(awgxy*Pi*xt*yt) - &
             augyz**2*Pi**2*ugyz*yt*zt*Sin(augyz*Pi*yt*zt))) + xt**2*(awgy*Pi*wgy*Cos(awgy*Pi*yt) + awgxy*Pi*wgxy*xt*Cos(awgxy*Pi*xt*yt) - &
          avgyz*Pi*vgyz*yt*Cos(avgyz*Pi*yt*zt) + awgyz*Pi*wgyz*zt*Cos(awgyz*Pi*yt*zt) + avgz*Pi*vgz*Sin(avgz*Pi*zt) + avgzx*Pi*vgzx*xt*Sin(avgzx*Pi*xt*zt))*&
        (2*xt*(-(awgy*Pi*wgy*Cos(awgy*Pi*yt)) - awgxy*Pi*wgxy*xt*Cos(awgxy*Pi*xt*yt) - awgyz*Pi*wgyz*zt*Cos(awgyz*Pi*yt*zt)) + &
          xt**2*(-(awgxy*Pi*wgxy*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*Cos(augyz*Pi*yt*zt) + awgxy**2*Pi**2*wgxy*xt*yt*Sin(awgxy*Pi*xt*yt) - &
             augyz**2*Pi**2*ugyz*yt*zt*Sin(augyz*Pi*yt*zt))) - mug*(2*xt*(-(avgzx**2*Pi**2*vgzx*xt*zt*Cos(avgzx*Pi*xt*zt)) - avgzx*Pi*vgzx*Sin(avgzx*Pi*xt*zt)) + &
          2*(avgyz*Pi*vgyz*yt*Cos(avgyz*Pi*yt*zt) - avgz*Pi*vgz*Sin(avgz*Pi*zt) - avgzx*Pi*vgzx*xt*Sin(avgzx*Pi*xt*zt)) + &
          xt**2*(-2*avgzx**2*Pi**2*vgzx*zt*Cos(avgzx*Pi*xt*zt) + avgzx**3*Pi**3*vgzx*xt*zt**2*Sin(avgzx*Pi*xt*zt)) + &
          2*xt*(-(avgzx**2*Pi**2*vgzx*xt*zt*Cos(avgzx*Pi*xt*zt)) - augyz*Pi*ugyz*Cos(augyz*Pi*yt*zt) - avgzx*Pi*vgzx*Sin(avgzx*Pi*xt*zt) + &
             augyz**2*Pi**2*ugyz*yt*zt*Sin(augyz*Pi*yt*zt))) + xt**2*(awgy*Pi*wgy*Cos(awgy*Pi*yt) + awgxy*Pi*wgxy*xt*Cos(awgxy*Pi*xt*yt) - &
          avgyz*Pi*vgyz*yt*Cos(avgyz*Pi*yt*zt) + awgyz*Pi*wgyz*zt*Cos(awgyz*Pi*yt*zt) + avgz*Pi*vgz*Sin(avgz*Pi*zt) + avgzx*Pi*vgzx*xt*Sin(avgzx*Pi*xt*zt))*&
        (2*xt*(avgyz*Pi*vgyz*yt*Cos(avgyz*Pi*yt*zt) - avgz*Pi*vgz*Sin(avgz*Pi*zt) - avgzx*Pi*vgzx*xt*Sin(avgzx*Pi*xt*zt)) + &
          xt**2*(-(avgzx**2*Pi**2*vgzx*xt*zt*Cos(avgzx*Pi*xt*zt)) - augyz*Pi*ugyz*Cos(augyz*Pi*yt*zt) - avgzx*Pi*vgzx*Sin(avgzx*Pi*xt*zt) + &
             augyz**2*Pi**2*ugyz*yt*zt*Sin(augyz*Pi*yt*zt))) + xt**2*(xt**2*&
           (avgx*Pi*vgx*Cos(avgx*Pi*xt) - augyz*Pi*ugyz*zt*Cos(augyz*Pi*yt*zt) + augy*Pi*ugy*Sin(augy*Pi*yt) + augxy*Pi*ugxy*xt*Sin(augxy*Pi*xt*yt) - &
             avgxy*Pi*vgxy*yt*Sin(avgxy*Pi*xt*yt) - avgzx*Pi*vgzx*zt*Sin(avgzx*Pi*xt*zt)) + &
          2*xt*(vg0 + vgy*Cos(avgy*Pi*yt) + vgxy*Cos(avgxy*Pi*xt*yt) + vgz*Cos(avgz*Pi*zt) + vgzx*Cos(avgzx*Pi*xt*zt) + vgx*Sin(avgx*Pi*xt) + vgyz*Sin(avgyz*Pi*yt*zt)))*&
        (avgz**2*Pi**2*vgz*Cos(avgz*Pi*zt) + avgzx**2*Pi**2*vgzx*xt**2*Cos(avgzx*Pi*xt*zt) + awgyz*Pi*wgyz*Cos(awgyz*Pi*yt*zt) + avgyz**2*Pi**2*vgyz*yt**2*Sin(avgyz*Pi*yt*zt) - &
          awgyz**2*Pi**2*wgyz*yt*zt*Sin(awgyz*Pi*yt*zt)) + xt**2*(-(avgyz*Pi*vgyz*Cos(avgyz*Pi*yt*zt)) - awgy**2*Pi**2*wgy*Sin(awgy*Pi*yt) - &
          awgxy**2*Pi**2*wgxy*xt**2*Sin(awgxy*Pi*xt*yt) + avgyz**2*Pi**2*vgyz*yt*zt*Sin(avgyz*Pi*yt*zt) - awgyz**2*Pi**2*wgyz*zt**2*Sin(awgyz*Pi*yt*zt))*&
        (xt**2*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) + awgx*Pi*wgx*Sin(awgx*Pi*xt) - augz*Pi*ugz*Sin(augz*Pi*zt) - &
             augzx*Pi*ugzx*xt*Sin(augzx*Pi*xt*zt) + awgzx*Pi*wgzx*zt*Sin(awgzx*Pi*xt*zt)) + &
          2*xt*(-wg0 - wgx*Cos(awgx*Pi*xt) - wgz*Cos(awgz*Pi*zt) - wgzx*Cos(awgzx*Pi*xt*zt) - wgy*Sin(awgy*Pi*yt) - wgxy*Sin(awgxy*Pi*xt*yt) - wgyz*Sin(awgyz*Pi*yt*zt))) - &
       mug*(4*xt*(awgxy*Pi*wgxy*Cos(awgxy*Pi*xt*yt) + avgzx**2*Pi**2*vgzx*xt*zt*Cos(avgzx*Pi*xt*zt) - awgxy**2*Pi**2*wgxy*xt*yt*Sin(awgxy*Pi*xt*yt) + &
             avgzx*Pi*vgzx*Sin(avgzx*Pi*xt*zt)) + 2*(awgy*Pi*wgy*Cos(awgy*Pi*yt) + awgxy*Pi*wgxy*xt*Cos(awgxy*Pi*xt*yt) - avgyz*Pi*vgyz*yt*Cos(avgyz*Pi*yt*zt) + &
             awgyz*Pi*wgyz*zt*Cos(awgyz*Pi*yt*zt) + avgz*Pi*vgz*Sin(avgz*Pi*zt) + avgzx*Pi*vgzx*xt*Sin(avgzx*Pi*xt*zt)) + &
          xt**2*(awgxy*Pi*wgxy*(-(awgxy**2*Pi**2*xt*yt**2*Cos(awgxy*Pi*xt*yt)) - 2*awgxy*Pi*yt*Sin(awgxy*Pi*xt*yt)) + &
      ...
      !vgsrc!
       ...
       mug*xt**2*(-(awgxy**3*Pi**3*wgxy*xt**2*yt*Cos(awgxy*Pi*xt*yt)) - 2*awgxy**2*Pi**2*wgxy*xt*Sin(awgxy*Pi*xt*yt)) + &
       (2*xt*(-(awgyz*Pi*wgyz*yt*Cos(awgyz*Pi*yt*zt)) + awgz*Pi*wgz*Sin(awgz*Pi*zt) + awgzx*Pi*wgzx*xt*Sin(awgzx*Pi*xt*zt)) + &
          xt**2*(-(augz**2*Pi**2*ugz*Cos(augz*Pi*zt)) - augzx**2*Pi**2*ugzx*xt**2*Cos(augzx*Pi*xt*zt) + awgzx**2*Pi**2*wgzx*xt*zt*Cos(awgzx*Pi*xt*zt) + &
             awgzx*Pi*wgzx*Sin(awgzx*Pi*xt*zt) - augyz**2*Pi**2*ugyz*yt**2*Sin(augyz*Pi*yt*zt)))*&
        (xt**2*(avgx*Pi*vgx*Cos(avgx*Pi*xt) - augyz*Pi*ugyz*zt*Cos(augyz*Pi*yt*zt) + augy*Pi*ugy*Sin(augy*Pi*yt) + augxy*Pi*ugxy*xt*Sin(augxy*Pi*xt*yt) - &
             avgxy*Pi*vgxy*yt*Sin(avgxy*Pi*xt*yt) - avgzx*Pi*vgzx*zt*Sin(avgzx*Pi*xt*zt)) + &
          2*xt*(vg0 + vgy*Cos(avgy*Pi*yt) + vgxy*Cos(avgxy*Pi*xt*yt) + vgz*Cos(avgz*Pi*zt) + vgzx*Cos(avgzx*Pi*xt*zt) + vgx*Sin(avgx*Pi*xt) + vgyz*Sin(avgyz*Pi*yt*zt))) - &
       mug*(xt**2*(augyz**3*Pi**3*ugyz*yt*zt**2*Cos(augyz*Pi*yt*zt) + 2*augyz**2*Pi**2*ugyz*zt*Sin(augyz*Pi*yt*zt)) + &
          2*xt*(avgyz*Pi*vgyz*Cos(avgyz*Pi*yt*zt) - avgyz**2*Pi**2*vgyz*yt*zt*Sin(avgyz*Pi*yt*zt))) - &
       2*mug*xt*(-(avgyz*Pi*vgyz*Cos(avgyz*Pi*yt*zt)) - awgy**2*Pi**2*wgy*Sin(awgy*Pi*yt) - awgxy**2*Pi**2*wgxy*xt**2*Sin(awgxy*Pi*xt*yt) + &
          avgyz**2*Pi**2*vgyz*yt*zt*Sin(avgyz*Pi*yt*zt) - awgyz**2*Pi**2*wgyz*zt**2*Sin(awgyz*Pi*yt*zt)) + &
       xt**2*(awgy*Pi*wgy*Cos(awgy*Pi*yt) + awgxy*Pi*wgxy*xt*Cos(awgxy*Pi*xt*yt) - avgyz*Pi*vgyz*yt*Cos(avgyz*Pi*yt*zt) + awgyz*Pi*wgyz*zt*Cos(awgyz*Pi*yt*zt) + &
          avgz*Pi*vgz*Sin(avgz*Pi*zt) + avgzx*Pi*vgzx*xt*Sin(avgzx*Pi*xt*zt))*&
        (xt**2*(awgx**2*Pi**2*wgx*Cos(awgx*Pi*xt) - augzx**2*Pi**2*ugzx*xt*zt*Cos(augzx*Pi*xt*zt) + awgzx**2*Pi**2*wgzx*zt**2*Cos(awgzx*Pi*xt*zt) + &
             awgxy**2*Pi**2*wgxy*yt**2*Sin(awgxy*Pi*xt*yt) - augzx*Pi*ugzx*Sin(augzx*Pi*xt*zt)) + &
          2*xt*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + awgx*Pi*wgx*Sin(awgx*Pi*xt) + awgzx*Pi*wgzx*zt*Sin(awgzx*Pi*xt*zt)) + &
          2*xt*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) + awgx*Pi*wgx*Sin(awgx*Pi*xt) - augz*Pi*ugz*Sin(augz*Pi*zt) - &
             augzx*Pi*ugzx*xt*Sin(augzx*Pi*xt*zt) + awgzx*Pi*wgzx*zt*Sin(awgzx*Pi*xt*zt)) + &
          2*(-wg0 - wgx*Cos(awgx*Pi*xt) - wgz*Cos(awgz*Pi*zt) - wgzx*Cos(awgzx*Pi*xt*zt) - wgy*Sin(awgy*Pi*yt) - wgxy*Sin(awgxy*Pi*xt*yt) - wgyz*Sin(awgyz*Pi*yt*zt))) + &
       xt**2*(awgxy*Pi*wgxy*Cos(awgxy*Pi*xt*yt) + avgzx**2*Pi**2*vgzx*xt*zt*Cos(avgzx*Pi*xt*zt) - awgxy**2*Pi**2*wgxy*xt*yt*Sin(awgxy*Pi*xt*yt) + &
          avgzx*Pi*vgzx*Sin(avgzx*Pi*xt*zt))*(xt**2*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) + awgx*Pi*wgx*Sin(awgx*Pi*xt) - &
             augz*Pi*ugz*Sin(augz*Pi*zt) - augzx*Pi*ugzx*xt*Sin(augzx*Pi*xt*zt) + awgzx*Pi*wgzx*zt*Sin(awgzx*Pi*xt*zt)) + &
          2*xt*(-wg0 - wgx*Cos(awgx*Pi*xt) - wgz*Cos(awgz*Pi*zt) - wgzx*Cos(awgzx*Pi*xt*zt) - wgy*Sin(awgy*Pi*yt) - wgxy*Sin(awgxy*Pi*xt*yt) - wgyz*Sin(awgyz*Pi*yt*zt))) + &
       2*xt*(awgy*Pi*wgy*Cos(awgy*Pi*yt) + awgxy*Pi*wgxy*xt*Cos(awgxy*Pi*xt*yt) - avgyz*Pi*vgyz*yt*Cos(avgyz*Pi*yt*zt) + awgyz*Pi*wgyz*zt*Cos(awgyz*Pi*yt*zt) + &
          avgz*Pi*vgz*Sin(avgz*Pi*zt) + avgzx*Pi*vgzx*xt*Sin(avgzx*Pi*xt*zt))*&
        (xt**2*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) + awgx*Pi*wgx*Sin(awgx*Pi*xt) - augz*Pi*ugz*Sin(augz*Pi*zt) - &
             augzx*Pi*ugzx*xt*Sin(augzx*Pi*xt*zt) + awgzx*Pi*wgzx*zt*Sin(awgzx*Pi*xt*zt)) + &
          2*xt*(-wg0 - wgx*Cos(awgx*Pi*xt) - wgz*Cos(awgz*Pi*zt) - wgzx*Cos(awgzx*Pi*xt*zt) - wgy*Sin(awgy*Pi*yt) - wgxy*Sin(awgxy*Pi*xt*yt) - wgyz*Sin(awgyz*Pi*yt*zt))) + &
       2*(2*xt*(-(awgy*Pi*wgy*Cos(awgy*Pi*yt)) - awgxy*Pi*wgxy*xt*Cos(awgxy*Pi*xt*yt) - awgyz*Pi*wgyz*zt*Cos(awgyz*Pi*yt*zt)) + &
          xt**2*(-(awgxy*Pi*wgxy*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*Cos(augyz*Pi*yt*zt) + awgxy**2*Pi**2*wgxy*xt*yt*Sin(awgxy*Pi*xt*yt) - &
             augyz**2*Pi**2*ugyz*yt*zt*Sin(augyz*Pi*yt*zt)))*(xt**2*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) + &
             awgx*Pi*wgx*Sin(awgx*Pi*xt) - augz*Pi*ugz*Sin(augz*Pi*zt) - augzx*Pi*ugzx*xt*Sin(augzx*Pi*xt*zt) + awgzx*Pi*wgzx*zt*Sin(awgzx*Pi*xt*zt)) + &
          2*xt*(-wg0 - wgx*Cos(awgx*Pi*xt) - wgz*Cos(awgz*Pi*zt) - wgzx*Cos(awgzx*Pi*xt*zt) - wgy*Sin(awgy*Pi*yt) - wgxy*Sin(awgxy*Pi*xt*yt) - wgyz*Sin(awgyz*Pi*yt*zt))) + &
       (2*xt*(avgyz*Pi*vgyz*yt*Cos(avgyz*Pi*yt*zt) - avgz*Pi*vgz*Sin(avgz*Pi*zt) - avgzx*Pi*vgzx*xt*Sin(avgzx*Pi*xt*zt)) + &
          xt**2*(-(avgzx**2*Pi**2*vgzx*xt*zt*Cos(avgzx*Pi*xt*zt)) - augyz*Pi*ugyz*Cos(augyz*Pi*yt*zt) - avgzx*Pi*vgzx*Sin(avgzx*Pi*xt*zt) + &
             augyz**2*Pi**2*ugyz*yt*zt*Sin(augyz*Pi*yt*zt)))*(xt**2*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) + &
             awgx*Pi*wgx*Sin(awgx*Pi*xt) - augz*Pi*ugz*Sin(augz*Pi*zt) - augzx*Pi*ugzx*xt*Sin(augzx*Pi*xt*zt) + awgzx*Pi*wgzx*zt*Sin(awgzx*Pi*xt*zt)) + &
          2*xt*(-wg0 - wgx*Cos(awgx*Pi*xt) - wgz*Cos(awgz*Pi*zt) - wgzx*Cos(awgzx*Pi*xt*zt) - wgy*Sin(awgy*Pi*yt) - wgxy*Sin(awgxy*Pi*xt*yt) - wgyz*Sin(awgyz*Pi*yt*zt))) - &
       mug*(xt**2*(awgxy**3*Pi**3*wgxy*xt**2*yt*Cos(awgxy*Pi*xt*yt) - augyz**3*Pi**3*ugyz*yt*zt**2*Cos(augyz*Pi*yt*zt) + 2*awgxy**2*Pi**2*wgxy*xt*Sin(awgxy*Pi*xt*yt) - &
             2*augyz**2*Pi**2*ugyz*zt*Sin(augyz*Pi*yt*zt)) + 2*xt*(awgy**2*Pi**2*wgy*Sin(awgy*Pi*yt) + awgxy**2*Pi**2*wgxy*xt**2*Sin(awgxy*Pi*xt*yt) + &
             awgyz**2*Pi**2*wgyz*zt**2*Sin(awgyz*Pi*yt*zt))) - mug*(2*xt*&
           (awgx**2*Pi**2*wgx*Cos(awgx*Pi*xt) + awgzx**2*Pi**2*wgzx*zt**2*Cos(awgzx*Pi*xt*zt) + awgxy**2*Pi**2*wgxy*yt**2*Sin(awgxy*Pi*xt*yt)) + &
          4*xt*(awgx**2*Pi**2*wgx*Cos(awgx*Pi*xt) - augzx**2*Pi**2*ugzx*xt*zt*Cos(augzx*Pi*xt*zt) + awgzx**2*Pi**2*wgzx*zt**2*Cos(awgzx*Pi*xt*zt) + &
             awgxy**2*Pi**2*wgxy*yt**2*Sin(awgxy*Pi*xt*yt) - augzx*Pi*ugzx*Sin(augzx*Pi*xt*zt)) + &
          4*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + awgx*Pi*wgx*Sin(awgx*Pi*xt) + awgzx*Pi*wgzx*zt*Sin(awgzx*Pi*xt*zt)) + &
          2*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) + awgx*Pi*wgx*Sin(awgx*Pi*xt) - augz*Pi*ugz*Sin(augz*Pi*zt) - &
             augzx*Pi*ugzx*xt*Sin(augzx*Pi*xt*zt) + awgzx*Pi*wgzx*zt*Sin(awgzx*Pi*xt*zt)) + &
          xt**2*(awgxy**3*Pi**3*wgxy*yt**3*Cos(awgxy*Pi*xt*yt) - awgx**3*Pi**3*wgx*Sin(awgx*Pi*xt) - &
             augzx*Pi*(2*augzx*Pi*ugzx*zt*Cos(augzx*Pi*xt*zt) - augzx**2*Pi**2*ugzx*xt*zt**2*Sin(augzx*Pi*xt*zt)) - awgzx**3*Pi**3*wgzx*zt**3*Sin(awgzx*Pi*xt*zt)) + &
          xt**2*(-(augyz**3*Pi**3*ugyz*yt**3*Cos(augyz*Pi*yt*zt)) + augz**3*Pi**3*ugz*Sin(augz*Pi*zt) + augzx**3*Pi**3*ugzx*xt**3*Sin(augzx*Pi*xt*zt) + &
             awgzx*Pi*wgzx*(2*awgzx*Pi*xt*Cos(awgzx*Pi*xt*zt) - awgzx**2*Pi**2*xt**2*zt*Sin(awgzx*Pi*xt*zt))) + &
          xt**2*(-(awgxy*Pi*(-(awgxy**2*Pi**2*wgxy*xt**2*yt*Cos(awgxy*Pi*xt*yt)) - 2*awgxy*Pi*wgxy*xt*Sin(awgxy*Pi*xt*yt))) + &
             augyz*Pi*ugyz*(-(augyz**2*Pi**2*yt*zt**2*Cos(augyz*Pi*yt*zt)) - 2*augyz*Pi*zt*Sin(augyz*Pi*yt*zt))) + &
          2*xt*(awgz**2*Pi**2*wgz*Cos(awgz*Pi*zt) + awgzx**2*Pi**2*wgzx*xt**2*Cos(awgzx*Pi*xt*zt) + awgyz**2*Pi**2*wgyz*yt**2*Sin(awgyz*Pi*yt*zt)) + &
          2*xt*(awgy**2*Pi**2*wgy*Sin(awgy*Pi*yt) + awgxy**2*Pi**2*wgxy*xt**2*Sin(awgxy*Pi*xt*yt) + awgyz**2*Pi**2*wgyz*zt**2*Sin(awgyz*Pi*yt*zt)))
      case(4)
      !wgsrc!
        mms_source = apgz*pgz*Pi*Cos(apgz*Pi*zt) + apgyz*pgyz*Pi*yt*Cos(apgyz*Pi*yt*zt) - apgzx*pgzx*Pi*xt*Sin(apgzx*Pi*xt*zt) - &
       mug*xt**2*(2*avgzx**2*Pi**2*vgzx*xt*Cos(avgzx*Pi*xt*zt) - avgzx**3*Pi**3*vgzx*xt**2*zt*Sin(avgzx*Pi*xt*zt)) + &
       xt**2*(awgy*Pi*wgy*Cos(awgy*Pi*yt) + awgxy*Pi*wgxy*xt*Cos(awgxy*Pi*xt*yt) - avgyz*Pi*vgyz*yt*Cos(avgyz*Pi*yt*zt) + awgyz*Pi*wgyz*zt*Cos(awgyz*Pi*yt*zt) + &
          avgz*Pi*vgz*Sin(avgz*Pi*zt) + avgzx*Pi*vgzx*xt*Sin(avgzx*Pi*xt*zt))*&
        (xt**2*(augxy**2*Pi**2*ugxy*xt*yt*Cos(augxy*Pi*xt*yt) - avgxy**2*Pi**2*vgxy*yt**2*Cos(avgxy*Pi*xt*yt) - avgzx**2*Pi**2*vgzx*zt**2*Cos(avgzx*Pi*xt*zt) - &
             avgx**2*Pi**2*vgx*Sin(avgx*Pi*xt) + augxy*Pi*ugxy*Sin(augxy*Pi*xt*yt)) + &
          2*xt*(avgx*Pi*vgx*Cos(avgx*Pi*xt) - avgxy*Pi*vgxy*yt*Sin(avgxy*Pi*xt*yt) - avgzx*Pi*vgzx*zt*Sin(avgzx*Pi*xt*zt)) + &
          2*xt*(avgx*Pi*vgx*Cos(avgx*Pi*xt) - augyz*Pi*ugyz*zt*Cos(augyz*Pi*yt*zt) + augy*Pi*ugy*Sin(augy*Pi*yt) + augxy*Pi*ugxy*xt*Sin(augxy*Pi*xt*yt) - &
             avgxy*Pi*vgxy*yt*Sin(avgxy*Pi*xt*yt) - avgzx*Pi*vgzx*zt*Sin(avgzx*Pi*xt*zt)) + &
          2*(vg0 + vgy*Cos(avgy*Pi*yt) + vgxy*Cos(avgxy*Pi*xt*yt) + vgz*Cos(avgz*Pi*zt) + vgzx*Cos(avgzx*Pi*xt*zt) + vgx*Sin(avgx*Pi*xt) + vgyz*Sin(avgyz*Pi*yt*zt))) + &
       xt**2*(awgxy*Pi*wgxy*Cos(awgxy*Pi*xt*yt) + avgzx**2*Pi**2*vgzx*xt*zt*Cos(avgzx*Pi*xt*zt) - awgxy**2*Pi**2*wgxy*xt*yt*Sin(awgxy*Pi*xt*yt) + &
          avgzx*Pi*vgzx*Sin(avgzx*Pi*xt*zt))*(xt**2*(avgx*Pi*vgx*Cos(avgx*Pi*xt) - augyz*Pi*ugyz*zt*Cos(augyz*Pi*yt*zt) + augy*Pi*ugy*Sin(augy*Pi*yt) + &
       ...
       (2*xt*(-(awgy*Pi*wgy*Cos(awgy*Pi*yt)) - awgxy*Pi*wgxy*xt*Cos(awgxy*Pi*xt*yt) - awgyz*Pi*wgyz*zt*Cos(awgyz*Pi*yt*zt)) + &
          xt**2*(-(awgxy*Pi*wgxy*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*Cos(augyz*Pi*yt*zt) + awgxy**2*Pi**2*wgxy*xt*yt*Sin(awgxy*Pi*xt*yt) - &
             augyz**2*Pi**2*ugyz*yt*zt*Sin(augyz*Pi*yt*zt)))*(xt**2*(avgx*Pi*vgx*Cos(avgx*Pi*xt) - augyz*Pi*ugyz*zt*Cos(augyz*Pi*yt*zt) + augy*Pi*ugy*Sin(augy*Pi*yt) + &
             augxy*Pi*ugxy*xt*Sin(augxy*Pi*xt*yt) - avgxy*Pi*vgxy*yt*Sin(avgxy*Pi*xt*yt) - avgzx*Pi*vgzx*zt*Sin(avgzx*Pi*xt*zt)) + &
          2*xt*(vg0 + vgy*Cos(avgy*Pi*yt) + vgxy*Cos(avgxy*Pi*xt*yt) + vgz*Cos(avgz*Pi*zt) + vgzx*Cos(avgzx*Pi*xt*zt) + vgx*Sin(avgx*Pi*xt) + vgyz*Sin(avgyz*Pi*yt*zt))) + &
       2*(2*xt*(avgyz*Pi*vgyz*yt*Cos(avgyz*Pi*yt*zt) - avgz*Pi*vgz*Sin(avgz*Pi*zt) - avgzx*Pi*vgzx*xt*Sin(avgzx*Pi*xt*zt)) + &
          xt**2*(-(avgzx**2*Pi**2*vgzx*xt*zt*Cos(avgzx*Pi*xt*zt)) - augyz*Pi*ugyz*Cos(augyz*Pi*yt*zt) - avgzx*Pi*vgzx*Sin(avgzx*Pi*xt*zt) + &
             augyz**2*Pi**2*ugyz*yt*zt*Sin(augyz*Pi*yt*zt)))*(xt**2*(avgx*Pi*vgx*Cos(avgx*Pi*xt) - augyz*Pi*ugyz*zt*Cos(augyz*Pi*yt*zt) + augy*Pi*ugy*Sin(augy*Pi*yt) + &
             augxy*Pi*ugxy*xt*Sin(augxy*Pi*xt*yt) - avgxy*Pi*vgxy*yt*Sin(avgxy*Pi*xt*yt) - avgzx*Pi*vgzx*zt*Sin(avgzx*Pi*xt*zt)) + &
          2*xt*(vg0 + vgy*Cos(avgy*Pi*yt) + vgxy*Cos(avgxy*Pi*xt*yt) + vgz*Cos(avgz*Pi*zt) + vgzx*Cos(avgzx*Pi*xt*zt) + vgx*Sin(avgx*Pi*xt) + vgyz*Sin(avgyz*Pi*yt*zt))) - &
       mug*(xt**2*(-2*avgzx**2*Pi**2*vgzx*xt*Cos(avgzx*Pi*xt*zt) + augyz**3*Pi**3*ugyz*yt**2*zt*Cos(augyz*Pi*yt*zt) + avgzx**3*Pi**3*vgzx*xt**2*zt*Sin(avgzx*Pi*xt*zt) + &
             2*augyz**2*Pi**2*ugyz*yt*Sin(augyz*Pi*yt*zt)) + 2*xt*(-(avgz**2*Pi**2*vgz*Cos(avgz*Pi*zt)) - avgzx**2*Pi**2*vgzx*xt**2*Cos(avgzx*Pi*xt*zt) - &
             avgyz**2*Pi**2*vgyz*yt**2*Sin(avgyz*Pi*yt*zt))) - mug*(2*xt*&
           (-(avgxy**2*Pi**2*vgxy*yt**2*Cos(avgxy*Pi*xt*yt)) - avgzx**2*Pi**2*vgzx*zt**2*Cos(avgzx*Pi*xt*zt) - avgx**2*Pi**2*vgx*Sin(avgx*Pi*xt)) + &
          4*xt*(augxy**2*Pi**2*ugxy*xt*yt*Cos(augxy*Pi*xt*yt) - avgxy**2*Pi**2*vgxy*yt**2*Cos(avgxy*Pi*xt*yt) - avgzx**2*Pi**2*vgzx*zt**2*Cos(avgzx*Pi*xt*zt) - &
             avgx**2*Pi**2*vgx*Sin(avgx*Pi*xt) + augxy*Pi*ugxy*Sin(augxy*Pi*xt*yt)) + &
          xt**2*(augyz**3*Pi**3*ugyz*zt**3*Cos(augyz*Pi*yt*zt) - augy**3*Pi**3*ugy*Sin(augy*Pi*yt) - augxy**3*Pi**3*ugxy*xt**3*Sin(augxy*Pi*xt*yt) - &
             avgxy*Pi*(2*avgxy*Pi*vgxy*xt*Cos(avgxy*Pi*xt*yt) - avgxy**2*Pi**2*vgxy*xt**2*yt*Sin(avgxy*Pi*xt*yt))) + &
          4*(avgx*Pi*vgx*Cos(avgx*Pi*xt) - avgxy*Pi*vgxy*yt*Sin(avgxy*Pi*xt*yt) - avgzx*Pi*vgzx*zt*Sin(avgzx*Pi*xt*zt)) + &
          2*(avgx*Pi*vgx*Cos(avgx*Pi*xt) - augyz*Pi*ugyz*zt*Cos(augyz*Pi*yt*zt) + augy*Pi*ugy*Sin(augy*Pi*yt) + augxy*Pi*ugxy*xt*Sin(augxy*Pi*xt*yt) - &
             avgxy*Pi*vgxy*yt*Sin(avgxy*Pi*xt*yt) - avgzx*Pi*vgzx*zt*Sin(avgzx*Pi*xt*zt)) + &
          xt**2*(-(avgx**3*Pi**3*vgx*Cos(avgx*Pi*xt)) + augxy*Pi*ugxy*(2*augxy*Pi*yt*Cos(augxy*Pi*xt*yt) - augxy**2*Pi**2*xt*yt**2*Sin(augxy*Pi*xt*yt)) + &
             avgxy**3*Pi**3*vgxy*yt**3*Sin(avgxy*Pi*xt*yt) + avgzx**3*Pi**3*vgzx*zt**3*Sin(avgzx*Pi*xt*zt)) + &
          xt**2*(-(avgzx*Pi*(2*avgzx*Pi*vgzx*xt*Cos(avgzx*Pi*xt*zt) - avgzx**2*Pi**2*vgzx*xt**2*zt*Sin(avgzx*Pi*xt*zt))) - &
             augyz*Pi*(-(augyz**2*Pi**2*ugyz*yt**2*zt*Cos(augyz*Pi*yt*zt)) - 2*augyz*Pi*ugyz*yt*Sin(augyz*Pi*yt*zt))) + &
          2*xt*(-(avgz**2*Pi**2*vgz*Cos(avgz*Pi*zt)) - avgzx**2*Pi**2*vgzx*xt**2*Cos(avgzx*Pi*xt*zt) - avgyz**2*Pi**2*vgyz*yt**2*Sin(avgyz*Pi*yt*zt)) + &
          2*xt*(-(avgy**2*Pi**2*vgy*Cos(avgy*Pi*yt)) - avgxy**2*Pi**2*vgxy*xt**2*Cos(avgxy*Pi*xt*yt) - avgyz**2*Pi**2*vgyz*zt**2*Sin(avgyz*Pi*yt*zt))) - &
       2*mug*xt*(avgz**2*Pi**2*vgz*Cos(avgz*Pi*zt) + avgzx**2*Pi**2*vgzx*xt**2*Cos(avgzx*Pi*xt*zt) + awgyz*Pi*wgyz*Cos(awgyz*Pi*yt*zt) + &
          avgyz**2*Pi**2*vgyz*yt**2*Sin(avgyz*Pi*yt*zt) - awgyz**2*Pi**2*wgyz*yt*zt*Sin(awgyz*Pi*yt*zt)) + &
       (2*xt*(avgyz*Pi*vgyz*zt*Cos(avgyz*Pi*yt*zt) - avgy*Pi*vgy*Sin(avgy*Pi*yt) - avgxy*Pi*vgxy*xt*Sin(avgxy*Pi*xt*yt)) + &
          xt**2*(augy**2*Pi**2*ugy*Cos(augy*Pi*yt) + augxy**2*Pi**2*ugxy*xt**2*Cos(augxy*Pi*xt*yt) - avgxy**2*Pi**2*vgxy*xt*yt*Cos(avgxy*Pi*xt*yt) - &
             avgxy*Pi*vgxy*Sin(avgxy*Pi*xt*yt) + augyz**2*Pi**2*ugyz*zt**2*Sin(augyz*Pi*yt*zt)))*&
        (xt**2*(-(awgxy*Pi*wgxy*yt*Cos(awgxy*Pi*xt*yt)) + augyz*Pi*ugyz*yt*Cos(augyz*Pi*yt*zt) + awgx*Pi*wgx*Sin(awgx*Pi*xt) - augz*Pi*ugz*Sin(augz*Pi*zt) - &
             augzx*Pi*ugzx*xt*Sin(augzx*Pi*xt*zt) + awgzx*Pi*wgzx*zt*Sin(awgzx*Pi*xt*zt)) + &
          2*xt*(-wg0 - wgx*Cos(awgx*Pi*xt) - wgz*Cos(awgz*Pi*zt) - wgzx*Cos(awgzx*Pi*xt*zt) - wgy*Sin(awgy*Pi*yt) - wgxy*Sin(awgxy*Pi*xt*yt) - wgyz*Sin(awgyz*Pi*yt*zt))) - &
       mug*(xt**2*(-(augyz**3*Pi**3*ugyz*yt**2*zt*Cos(augyz*Pi*yt*zt)) - 2*augyz**2*Pi**2*ugyz*yt*Sin(augyz*Pi*yt*zt)) + &
          2*xt*(-(awgyz*Pi*wgyz*Cos(awgyz*Pi*yt*zt)) + awgyz**2*Pi**2*wgyz*yt*zt*Sin(awgyz*Pi*yt*zt)))
      case(5)
      !ussrc!
        mms_source = zero
      case(6)
