...
!$omp           Uge, Ugw, Ugs, Ugn, Wgt, Wgb, Ugt, Ugb, F_vir,       &
!$omp           F_Lift, Vsw, Vse, Vsc, U_slip, gradVg, VMT,          &
...
! Lift Force implemented for a special case, i.e. this is not a general implementation.
                     ...
                     Vse = AVG_Y_N(V_s(IPJMK,M),V_s(IPJK,M))
                     Vsc = AVG_X(Vsw,Vse,I)
                     U_slip = (AVG_X(Vgw,Vge,I) - Vsc)
