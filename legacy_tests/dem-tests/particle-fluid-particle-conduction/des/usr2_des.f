...
! Calculate the value for the analytic solutions.
      ...
      A_C = 0.0401067383450698d0
      B_C = 0.0160219735083726d0
...
! Write the data to a file.
      WRITE(TP_UNIT1,"(4(3X,F12.8))")S_TIME,Tp1,DES_T_s(1),REL_ERR1
      CLOSE(TP_UNIT1)

      WRITE(TP_UNIT2,"(4(3X,F12.8))")S_TIME,Tp2,DES_T_s(2),REL_ERR2
      CLOSE(TP_UNIT2)
