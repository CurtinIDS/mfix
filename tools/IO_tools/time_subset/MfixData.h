...
public:
   ...
   void ReadWriteValues(std::ifstream & in , FILE_POSITION offset , int spxNum , int nvars ,
                const std::string & fname , float t0 , float t1);
   ...
   void Time_subset_SPx(float t0 , float t1);
