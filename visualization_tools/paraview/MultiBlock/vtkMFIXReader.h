...
class VTK_IO_EXPORT vtkMFIXReader : public vtkMultiBlockDataSetAlgorithm
{
public:
  static vtkMFIXReader *New();
  vtkTypeRevisionMacro(vtkMFIXReader,vtkMultiBlockDataSetAlgorithm);
...
private:
  void MakeMesh(vtkMultiBlockDataSet *output);
